...
pages = [
    ...
    st.Page("pages/08_level7_noise.py", title=t("nav_level7")),
    st.Page("pages/09_level8_circuit_reading.py", title=t("nav_level8")),
    st.Page("pages/11_level9_measurement_statistics.py", title=t("nav_level9")),
