...
![Two-path interference](assets/images/level11_two_path_interference.svg)
...
The double-slit experiment is the classic example of this idea. Light or particles have path possibilities through the two slits, and the screen shows repeating bright and dark bands. This picture is for intuition; the quantum calculation comes from adding probability amplitudes.
...
![Phase examples](assets/images/level11_phase_examples.svg)
...
The Deutsch algorithm in Level 7 does not print every answer at once. Instead, the oracle leaves sign and phase differences, and the final `H` mixes the paths again so constant and balanced rules lead to different measurement results.

![Deutsch algorithm and interference](assets/images/level11_deutsch_interference_bridge.svg)
